...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-background flex flex-col">
      <PageHeader title="Login" imageSrc="/merchlogo.png" imageClassName="object-[center_48%]" />
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <Link href="/reset-password" className="text-xs font-bold text-blue-600 hover:underline">Forgot Password?</Link>
              </div>
              <input 
                type="password" 
                value={password}
